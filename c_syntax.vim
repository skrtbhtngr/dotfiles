...
" https://github.com/neovim/neovim/blob/master/runtime/syntax/c.vim
" and then customized.
...
if exists("c_gnu")
  ...
  syn keyword	cType	loff_t size_t ssize_t ptrdiff_t clock_t caddr_t
  syn keyword	cType	ktime_t sector_t blkcnt_t pgoff_t dma_addr_t
  syn keyword	cType	gfp_t slab_flags_t fmode_t phys_addr_t resource_size_t
...
if exists("c_gnu")
    " Some Linux kernel stuff
    syn keyword cStorageClass	__init __exit
endif
...
hi Function gui=bold guifg=#d05a51
hi Type guifg=#e6a545
hi Structure guifg=#e6a545
